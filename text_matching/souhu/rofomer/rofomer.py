...
# bert配置
config_path = '/root/lwl/chinese_roformer_L-12_H-768_A-12/bert_config.json'
checkpoint_path = '/root/lwl/chinese_roformer_L-12_H-768_A-12/bert_model.ckpt'
dict_path = '/root/lwl/chinese_roformer_L-12_H-768_A-12/vocab.txt'
...
if __name__ == '__main__':
    ...
    model.load_model('best_model.h5',custom_objects={'F1': F1, 'Precision': Precision,
                                                    'Recall': Recall,})
    # predict_test('test.csv')
