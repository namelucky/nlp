...
def textcnn1(embedding_matrix,embedding_size = 300,max_sentence_length = 20,max_body_length=60,
    ...
    encode2=Bidirectional(LSTM(128, return_sequences=False))
    ...
    # q3_encoded=q3_encoded[:, -1,:]
    # q4_encoded = q4_encoded[:, -1, :]
    print('q3_encoded',q3_encoded)

    #
    subm=submult(q3_encoded,q4_encoded)
    subm_drop=Dropout(0.6)(subm)

    X_input=tf.stack([q3_embed,q4_embed],axis=0)
    ...
    # X_1 = MaxPooling2D(pool_size=(300, 1), padding='valid')(X_1)
    # X_1 = Flatten()(X_1)
    # print('X_1',X_1)
    ...
    # # print("atten",atten)
    a_pool=GlobalAveragePooling1D()(atten)
    a_max=GlobalMaxPooling1D()(atten)
    # print('a_max',a_max)
    ...
    dense = Concatenate()([q1_rep, q2_rep,a_pool,a_max,subm])
