...
embedding_data_catalog = './embedding_data/'
...
def train_deep_model():
    ...
    y_train = np.array(load("preprocessing/" + 'train_y.pickle'))



    X_train_s1 = load(embedding_data_catalog + 's1_train_sequences_pad.pickle')
    print('X_train_s1 shape',X_train_s1.shape)
    X_train_s2= load(embedding_data_catalog + 's2_train_sequences_pad.pickle')
    ...
    model_checkpoint_path = "model_file/" + 'model_title_rev.h5'
...
def mypredict():
    ...
    X_test_s1_char = load(embedding_data_catalog + 's1_test_sequences_pad.pickle')
    print(type(X_test_s1_char))
    print(X_test_s1_char.shape)
    X_test_s2_char = load(embedding_data_catalog + 's2_test_sequences_pad.pickle')


    flag=0
    y_test = np.array(load("preprocessing/" + 'test_y.pickle'))
    ...
    model_path = "./model_file/" + 'model_title_rev.h5'
