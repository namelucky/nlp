...
#
# # #划分训练集测试集 8：2
data_df = pd.read_csv("preprocessing/2018/mypair_{}_preprocessed.csv".format(file), sep='\t', names=["id", "question1", "question2", "duplicated", "s1_title", "s2_title", "s1_body", "s2_body", "maintag"], encoding='utf-8-sig',lineterminator="\n")
stat(data_df)
