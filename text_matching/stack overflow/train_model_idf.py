...
def train_deep_model():
    ...
    print('X_train_s1 shape',X_train_s1.shape)
    X_train_s2= load(embedding_body_catalog + 's2_train_sequences_pad.pickle')
    X_train_body1 = load(embedding_body_catalog + 'body1_train_sequences_pad.pickle')
    X_train_body2= load(embedding_body_catalog + 'body2_train_sequences_pad.pickle')
    # print('X_train_body1 shape',X_train_body1.shape)

    # X_train_body1 = load(embedding_catalog + 'train_doc2vec_body100.pickle')
    # # print('body,',X_train_body1)
    # print('body shape',np.array(X_train_body1).shape)
    # X_train_body2= load(embedding_catalog + 'train_doc2vec_body200.pickle')
    ...
    model_checkpoint_path = "model_file/2018/" + 'model_idf.h5'
...
def mypredict():
    ...
    X_test_body1_char = load(embedding_body_catalog + 'body1_test_sequences_pad.pickle')
    X_test_body2_char = load(embedding_body_catalog + 'body2_test_sequences_pad.pickle')
    ...
    model_path = "./model_file/2018/" + 'model_idf.h5'
