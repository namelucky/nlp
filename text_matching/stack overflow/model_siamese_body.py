...
def textcnn1(embedding_matrix,embedding_size = 300,max_sentence_length = 20,max_body_length=60,
    ...
    # q1_compare=q1_combined
    # q2_compare=q2_combined
    # Aggregate
    ...
    # q3_compare=q3_combined
    # q4_compare=q4_combined
    ...
    dense = Concatenate()([q1_rep,q2_rep,q3_rep, q4_rep,])
    dense=Dropout(0.5)(dense)
    dense=Concatenate()([dense,a_max,a_pool])
